...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        if ($isEdit) {
            $db->updateProduct($_GET['id'], [$name, $description, $short_desc, $price, $stock, $discount, $image, $category_id]);
    ...
    <div class="app-wrapper">
        ...
        <main class="app-main">
            ...
            <div class="card card-primary card-outline mb-4">
                ...
                <!--end::Header-->
                <!--begin::Form-->
                <form action="<?php echo $isEdit ? '?id=' . $_GET['id'] : '#'; ?>" method="post" id="productForm">
                    <!--begin::Body-->
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <input type="file" class="form-control" id="inputGroupFile02" name="product-image" accept="image/*" />
                    ...
                    <div class="card-footer">
                        <div style="justify-self:flex-end">
                            <button type="button" class="btn btn-outline-secondary mb-2" onclick="window.location.href='../../show-products.php';">Cancel</button>
                            <input type="submit" class="btn btn-success mb-2" value="<?php echo $isEdit ? 'Update' : 'Add'; ?>">
                        </div>
                    </div>
                    <!--end::Footer-->
                </form>
