...
<head>
    ...
    <title>FastBuy | Category items</title>
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Category Products</h3>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body p-0">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $products = $db->getProductsByCategory($_GET['id']);
        ...
        function confirmDelete(id, productName) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/FastBuy/admin/actions/product/delete-product.php?id=' + id + 'place=category_items';
                }
            });
        }
    </script>
