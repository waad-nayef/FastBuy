...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="<?php echo htmlspecialchars($product['image'] ?? 'placeholder.jpg'); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
                            <div class="product-details">
                                ...
                                <div class="price">
                                    ...
                                    ?>
                                    <h6>$<?php echo number_format($final_price, 2); ?></h6>
                                    <?php if ($discount > 0): ?>
                                    <h6 class="l-through">$<?php echo number_format($price, 2); ?></h6>
                                    <?php endif; ?>
                                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <div class="section-title">
                            ...
                            <p>Upcoming releases you don't want to miss.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
    ...
    <section class="brand-area section_gap">
        <div class="container">
            <div class="row">
                <a class="col single-img" href="#"><img class="img-fluid d-block mx-auto" src="img/brand/1.png" alt=""></a>
                <a class="col single-img" href="#"><img class="img-fluid d-block mx-auto" src="img/brand/2.png" alt=""></a>
